...
from app.api.routes.interview_prep_storage import router as interview_prep_storage_router
...
api_router.include_router(interview_prep_storage_router)
...
api_router.include_router(day_in_life_storage_router)